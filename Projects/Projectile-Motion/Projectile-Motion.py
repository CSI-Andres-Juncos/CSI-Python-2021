...
def ProjectileFunction(Gun:str,Caliber:str,Ammunition:str,Velocity_Ms:int,Building:str,BuildingHeight_m:int,gravity_Ms:int):
...
ProjectileFunction("OP-SKS","7.62x39mm","MAI AP",875,"One World Trade Center",541.3,9.81)
